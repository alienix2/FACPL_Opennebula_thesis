...
\begin{lstlisting}[language=Java, label=code:VMsInfoLogging, xleftmargin=1em, basicstyle=\fontsize{9}{10}\ttfamily]
...
\begin{lstlisting}[language=XML, caption=Repository locale, label=code:libsxml]
<repositories>
    <repository>
        <id>local-libs</id>
